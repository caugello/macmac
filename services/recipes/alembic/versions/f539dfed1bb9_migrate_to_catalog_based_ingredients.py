...
def upgrade() -> None:
    ...
    op.create_index('ix_recipe_ingredient_catalog_item_id', 'recipe_ingredients', ['catalog_item_id'])
...
def downgrade() -> None:
    ...
    op.add_column('recipes', sa.Column('ingredients', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='[]'))
